    ...
    :return:
        This function returns a dictionary, with the following keys—
            1) 'beta_used':
                ...
                estimates.
            2) 'profile':
                A records-oriented JSON of the input profile data, the specified age interval, and the calculated
                absolute risk estimates. If 'return_linear_predictors' is set to True, they are also included in this
            ...
            3) 'reference_risks':
                ...
                contain a records-oriented JSON of the absolute risk estimates for each individual in the reference
                dataset (columns are individuals) for each unique combination of the specified age interval. A Pandas
                DataFrame can be reconstructed similar to the 'profile' key.
    """
